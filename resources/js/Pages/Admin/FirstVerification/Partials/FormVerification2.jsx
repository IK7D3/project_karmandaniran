...
const FormVerification1 = ({ data }) => {
    ...
    const filteredData =  data.filter(item => item.initial_request == 3);
                ...
                <thead class=" bg-amber-200">
                    ...
                    <th scope="col" class="px-6  py-3">
                        ...
                        <th scope="col" class="px-6 py-3 ">
                            ...
                            <div className="w-20">ارسال پیام</div>
                ...
                <tbody className=" text-xs">
                    {currentItems.map((item) => (
                        <tr class="bg-white border-b ">
                            ...
                            {item.first_message == 0 ? 
                                <td class="px-6 py-5 font-semibold">
                                <Link 
                                    className="text-orange-600 "
                                    href={route("admin.sendFirstMessage", { item,  status: item.first_message})}
                                    method="post"
                                >
                                    ارسال
                                </Link>
                                ...
                                <td class="px-6 py-5 font-semibold">
                                    <span className="text-green-500">ارسال شد</span>
                                </td>
                                    }
                            <td className="px-6">{item.first_payment_code}</td>
                            <td class="px-6 py-5 font-semibold">
                                <Link 
